    ...
    <div class="resume-box mb-5">
        <div class="left-section">
            ...
            <div class="info">
                ...
                <p class="p1"><span class="span1"><img src="/asset/formCv/image/location.png"></span>Address<span>
                        <br><input type="text" name="" class="custom-input-form-cv pd-5"></span></p>
                <p class="p1"><span class="span1"><img src="/asset/formCv/image/call.png"></span>Phone<span>
                        <br><input type="text" name="" class="custom-input-form-cv pd-5"></span></p>
                <p class="p1"><span class="span1"><img src="/asset/formCv/image/mail.png"></span>Email<span>
                        <br><input type="text" name="" class="custom-input-form-cv pd-5"></span></p>
            </div>
        ...
        <div class="right-section">
            ...
            <p class="p3">
                <textarea name="" class="custom-input-form-cv" cols="65" rows="5" style="background: #f6f7f9"></textarea>
            </p>
            ...
            <div class="lr-box" v-for="(item, index) in experience" :key="item">
                <div class="left">
                    <p class="p4"><input type="text" :name="'timeProject[ ' + index + ' ]'" v-model="item.timeProject"
                ...
                <div class="right">
                    <p class="p4"><input type="text" v-model="item.nameProject" :name="'nameProject[ ' + index + ' ]'"
                            style="max-width: 100%; width: 350px" class="custom-input-form-cv" placeholder="Tên dự án"></p>
                    <p class="p5">
            ...
            <div class="lr-box" v-for="(item, index) in ducation" :key="item">
                ...
                <div class="right">
                    <p class="p4"><input type="text" v-model="item.nameDucation" :name="'nameDucation[ ' + index + ' ]'"
                            style="max-width: 100%; width: 350px" class="custom-input-form-cv" placeholder="Tên trường"></p>
                </div>
                <div class="clearfix"></div>
            ...
            <div class="mt-2" v-for="(item, index) in skill" :key="item">
                <input type="text" v-model="item.nameSkill" :name="'nameSkill[ ' + index + ' ]'" style="max-width: 100%;"
                    class="custom-input-form-cv mt-2" placeholder="Tên kỹ năng">
                <i class="fas fa-plus" @click="addSkill" style="cursor: pointer; margin-left: 20px; margin-top: 5px;"></i>
